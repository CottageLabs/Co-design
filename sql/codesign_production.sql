...
CREATE SCHEMA IF NOT EXISTS `codesign_production` DEFAULT CHARACTER SET utf8 ;
USE `codesign_production` ;

-- -----------------------------------------------------
-- Table `codesign_production`.`category`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `codesign_production`.`user`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `codesign_production`.`user` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `codesign_production`.`idea`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `codesign_production`.`idea` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `idea_ibfk_1`
    FOREIGN KEY (`user_id` )
    REFERENCES `codesign_production`.`user` (`id` )
    ON UPDATE CASCADE,
  CONSTRAINT `idea_ibfk_2`
    FOREIGN KEY (`category_id` )
    REFERENCES `codesign_production`.`category` (`id` )
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `codesign_production`.`project`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `codesign_production`.`project` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(100) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `codesign_production`.`comment`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `codesign_production`.`comment` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  `user_id` INT(11) NOT NULL ,
  ...
  CONSTRAINT `fk_comment_idea1`
    FOREIGN KEY (`idea_id` )
    REFERENCES `codesign_production`.`idea` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_comment_project1`
    FOREIGN KEY (`project_id` )
    REFERENCES `codesign_production`.`project` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `codesign_production`.`group`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `codesign_production`.`group` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `codesign_production`.`idea_project`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `codesign_production`.`idea_project` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `codesign_production`.`license`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `codesign_production`.`license` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(255) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `codesign_production`.`open_question`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `codesign_production`.`open_question` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `codesign_production`.`open_answer`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `codesign_production`.`open_answer` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `open_answer_ibfk_1`
    ...
    REFERENCES `codesign_production`.`open_question` (`id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
AUTO_INCREMENT = 168
...
-- -----------------------------------------------------
-- Table `codesign_production`.`open_project_has_answer`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `codesign_production`.`open_project_has_answer` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_open_project_has_answer_open_answer1`
    ...
    REFERENCES `codesign_production`.`open_answer` (`open_question_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `codesign_production`.`project_user`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `codesign_production`.`project_user` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  `project_id` INT(11) NOT NULL ,
  `user_id` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `codesign_production`.`tag`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `codesign_production`.`tag` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `codesign_production`.`tag_idea`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `codesign_production`.`tag_idea` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `tag_idea_ibfk_1`
    FOREIGN KEY (`tag_id` )
    REFERENCES `codesign_production`.`tag` (`id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `codesign_production`.`tag_project`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `codesign_production`.`tag_project` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  `tag_id` INT(11) NOT NULL ,
  `project_id` INT(11) NOT NULL ,
  PRIMARY KEY (`id`) ,
...
-- -----------------------------------------------------
-- Table `codesign_production`.`user_group`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `codesign_production`.`user_group` (
  `user_id` INT(11) NOT NULL ,
  ...
  CONSTRAINT `fk_user_has_group_group2`
    ...
    REFERENCES `codesign_production`.`group` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Data for table `codesign_production`.`license`
-- -----------------------------------------------------
START TRANSACTION;
USE `codesign_production`;
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (1, 'Academic Free License 3.0', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (2, 'Adaptive Public License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (3, 'Affero GNU Public License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (4, 'Apache License 2.0', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (5, 'Artistic License 2.0', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (6, 'Attribution Assurance Licenses', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (7, 'Boost Software License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (8, 'Common Development and Distribution License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (9, 'Common Public Attribution License 1.0', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (10, 'Common Public License 1.0', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (11, 'Eclipse Public License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (12, 'Educational Community License Version 2.0', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (13, 'Eiffel Forum License v2.0', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (14, 'European Union Public License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (15, 'Fair License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (16, 'GNU General Public License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (17, 'GNU General Public License v3.0', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (18, 'GNU Library or \'Lesser\' General Public License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (19, 'GNU Library or \'Lesser\' General Public License v3.0', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (20, 'Historical Permission Notice and Disclaimer', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (21, 'IPA Font License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (22, 'ISC License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (23, 'Lucent Public License Version 1.02', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (24, 'MIT license', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (25, 'Microsoft Public License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (26, 'Microsoft Reciprocal License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (27, 'MirOS License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (28, 'Mozilla Public License 1.1', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (29, 'NASA Open Source Agreement 1.3', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (30, 'NTP License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (31, 'BSD licenses - New and Simplified', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (32, 'Non-Profit Open Software License 3.0', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (33, 'Open Font License 1.1', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (34, 'Open Group Test Suite License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (35, 'Open Software License 3.0', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (36, 'Qt Public License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (37, 'Reciprocal Public License 1.5', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (38, 'Simple Public License 2.0', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (39, 'University of Illinois/NCSA Open Source License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (40, 'X.Net License', NULL);
INSERT INTO `codesign_production`.`license` (`id`, `name`, `url`) VALUES (41, 'zlib/libpng license', NULL);

COMMIT;

-- -----------------------------------------------------
-- Data for table `codesign_production`.`open_question`
-- -----------------------------------------------------
START TRANSACTION;
USE `codesign_production`;
INSERT INTO `codesign_production`.`open_question` (`id`, `question`, `max_score`, `section`, `sub_question`, `help`, `type`, `has_dont_know_answer`) VALUES (1, 'Project Name', 5, 'info', 'Please provide a project name.', 'A name is needed to label the idea but it can be changed at each stage. <a href=\"/resources/faq#create-ans1\" target=\"_blank\">FAQ</a>', 'text', 0);
...
-- -----------------------------------------------------
-- Data for table `codesign_production`.`open_answer`
-- -----------------------------------------------------
START TRANSACTION;
USE `codesign_production`;
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (1, 5, 'text-reserved', 1);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (2, 5, 'text-reserved', 2);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (3, 5, 'text-reserved', 3);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (4, 5, 'text-reserved', 4);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (5, 3, 'Proprietary', 5);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (6, 3, 'OSI approved', 5);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (7, 3, 'Recognised by FSF', 5);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (8, 3, 'Both OSI and FSF approved', 5);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (9, 1, 'A specific group', 6);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (10, 1, 'A specfic user', 6);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (11, 5, 'Anyone', 6);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (12, 1, 'No', 7);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (13, 2, 'Yes, but the audit process is undocumented', 7);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (14, 3, 'Yes, there is a documented audit process', 7);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (15, 5, 'Yes, there is a documented audit process which is followed before each release', 7);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (16, 3, 'A specified sub-set', 8);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (17, 3, 'A specified super-set', 8);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (18, 5, 'Anyone', 8);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (19, 3, 'A specified sub-set', 9);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (20, 3, 'A specified super-set', 9);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (21, 5, 'All licencees', 9);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (22, 2, 'A specified sub-set', 10);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (23, 2, 'A specified super-set', 10);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (24, 5, 'All licencees', 10);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (25, 0, 'No', 11);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (26, 3, 'Yes, but with conditions', 11);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (27, 3, 'Yes, unconditionally', 11);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (28, 0, 'No', 12);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (29, 3, 'Yes', 12);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (30, 0, 'No', 13);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (31, 3, 'Sometimes', 13);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (32, 5, 'Yes', 13);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (33, 0, 'No', 14);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (34, 5, 'Yes', 14);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (35, 0, 'No', 15);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (36, 5, 'Yes', 15);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (37, 0, 'Implementation costs', 16);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (38, 2, 'Acquisition costs', 16);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (39, 5, 'No costs', 16);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (40, 0, 'No', 17);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (41, 1, 'Some', 17);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (42, 3, 'Yes', 17);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (43, 0, 'No', 18);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (44, 3, 'Yes', 18);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (45, 0, 'No', 19);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (46, 2, 'Yes', 19);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (47, NULL, 'Documentation section of website', 20);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (48, NULL, 'Design documents', 20);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (49, NULL, 'Project roadmap', 20);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (50, NULL, 'Machine readable meta-data', 20);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (51, NULL, 'Publicly writeable wiki', 20);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (52, NULL, 'Version control system', 20);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (53, NULL, 'Email lists or online forums', 20);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (54, NULL, 'Instant messaging/IRC', 20);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (55, NULL, 'Issue Tracker', 20);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (56, 0, 'No', 21);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (57, 3, 'Yes', 21);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (58, 3, 'No', 22);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (59, 1, 'Yes, but only via a semi-private mechanism', 22);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (60, 0, 'Yes', 22);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (61, 3, 'No', 23);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (62, 1, 'Yes, but only for legal or privacy issues', 23);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (63, 0, 'Yes', 23);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (64, 0, 'A subset of participants', 24);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (65, 3, 'All participants, including users', 24);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (66, 5, 'Anyone', 24);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (67, 5, 'No', 25);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (68, 2, 'Yes, but only private data', 25);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (69, 0, 'Yes', 25);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (70, 5, 'No', 26);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (71, 2, 'Yes, some knowledge or technology required', 26);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (72, 0, 'Yes', 26);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (73, 0, 'No', 27);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (74, 2, 'Some knowledge is', 27);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (75, 5, 'Yes', 27);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (76, 0, 'No', 28);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (77, 3, 'Yes', 28);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (78, 0, 'Only a closed group', 29);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (79, 3, 'Only project participants', 29);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (80, 5, 'Anyone', 29);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (81, 0, 'No publicly available archives', 30);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (82, 1, 'Some publicly available archives', 30);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (83, 3, 'Publicly available archives of all materials', 30);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (84, 2, 'Yes, but only for some data', 31);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (85, 5, 'Yes', 31);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (86, 0, '0', 32);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (87, 1, '1', 32);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (88, 2, '2', 32);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (89, 3, '3', 32);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (90, 4, '4', 32);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (91, 5, '5', 32);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (92, 0, '0', 33);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (93, 1, '1', 33);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (94, 2, '2', 33);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (95, 3, '3', 33);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (96, 4, '4', 33);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (97, 5, '5', 33);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (98, 3, 'No', 34);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (99, 1, 'Yes', 34);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (100, 0, 'No', 35);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (101, 5, 'Yes', 35);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (102, 0, 'No governance documentation', 36);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (103, 1, 'Partial (includes one or more of the above items)', 36);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (104, 3, 'Yes (includes all of the above items)', 36);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (105, 0, 'No', 37);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (106, 3, 'Yes', 37);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (107, 0, 'No', 38);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (108, 1, 'Yes, but only for users or developers', 38);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (109, 3, 'Yes, for both users and developers', 38);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (110, 2, 'No', 39);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (111, 3, 'Yes', 39);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (112, 1, 'A closed group', 40);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (113, 3, 'Participants willing to register in some way', 40);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (114, 5, 'Anyone', 40);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (115, 0, 'No', 41);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (116, 1, 'Yes, but only those with write access to resources', 41);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (117, 3, 'Yes, for all contributions containing significant IP', 41);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (118, 1, 'A self appointed group', 42);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (119, 3, 'Anyone who earns sufficient merit', 42);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (120, 5, 'Partially self appointed, partially meritocratic group', 42);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (121, 0, 'Anyone', 42);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (122, 0, 'No', 43);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (123, 2, 'Yes, with one person having access', 43);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (124, 5, 'Yes, with more then 1 person having access', 43);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (125, 0, 'Only a specific group', 44);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (126, 3, 'A super-set of people', 44);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (127, 5, 'Anyone', 44);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (129, 0, 'No', 45);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (130, 3, 'Yes, although some local configuration and setup is required', 45);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (131, 5, 'Yes, there is a fully automated installer', 45);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (132, 0, 'Inconsistent and unpredictable', 46);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (133, 2, 'Inconsistent or unpredictable', 46);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (134, 3, 'Consistent and predictable', 46);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (135, 0, 'No', 47);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (136, 1, 'Yes, with technical or access limitations', 47);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (137, 3, 'Yes', 47);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (138, 0, 'No', 48);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (139, 3, 'Yes', 48);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (140, 5, 'No', 49);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (141, 3, 'Yes, a fixed fee', 49);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (142, 0, 'Yes, on a revenue basis', 49);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (143, 5, 'No', 50);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (144, 3, 'Yes, some', 50);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (145, 0, 'Yes', 50);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (146, 0, '1', 51);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (147, 3, '2', 51);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (148, 5, '3 or more', 51);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (149, 1, 'A minority', 52);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (150, 3, 'A majority', 52);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (151, 5, 'All', 52);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (152, 0, 'Not viable', 53);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (153, 1, 'Not viable, but will be with further development', 53);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (154, 3, 'Quite viable', 53);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (155, 5, 'Viable', 53);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (156, 1, 'Customisation', 54);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (157, 1, 'Support and maintenance', 54);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (158, 1, 'Hosted services', 54);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (159, 1, 'Implementation/deployment services', 54);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (160, 1, 'Training', 54);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (161, 1, 'Dual licensing', 54);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (162, 1, 'Localisation/internationalisation', 54);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (163, 1, 'Consulting', 54);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (164, 1, 'Proprietary extensions', 54);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (165, 0, '0', 55);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (166, 2, '1-2', 55);
INSERT INTO `codesign_production`.`open_answer` (`id`, `value`, `answer`, `open_question_id`) VALUES (167, 5, '3 or more', 55);
